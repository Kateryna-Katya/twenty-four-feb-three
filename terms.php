...
<body>
    ...
    <section class="pages">
        <div class="container">
            <span class="section-tag" data-gsap="fade-up">Terms & Conditions</span>
            <h1 data-gsap="fade-up">Условия использования</h1>

            <div class="legal-content">
                <div class="policy-hero-card terms-accent" data-gsap="fade-up">
                    <p>
                ...
                <div class="legal-section" data-gsap="fade-up">
                    ...
                    <p>
                        ...
                        развития на базе передовой цифровой инфраструктуры.
                    </p>
                </div>
                ...
                <div class="legal-section" data-gsap="fade-up">
                    ...
                    <ul class="legal-list">
                        ...
                        <li>Искажать данные при заполнении форм обратной связи.</li>
                    </ul>
                </div>

                <div class="legal-section" data-gsap="fade-up">
                    <div class="property-block">
                        <div class="p-icon"><i data-lucide="copyright"></i></div>
                        <div class="p-text">
                            <h2>3. Интеллектуальная собственность</h2>
                            <p>
                                Весь контент на <strong><?= $fullDomain ?></strong> (тексты, код, графика, логотипы) является собственностью Компании. 
                                Вам предоставляется ограниченная лицензия для личного использования. Копирование или перепродажа материалов запрещены.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="legal-section" data-gsap="fade-up">
                    <div class="warning-block terms-warning">
                        <div class="w-icon"><i data-lucide="shield-alert"></i></div>
                        <div>
                            <h2>4. Ограничение ответственности</h2>
                            <p>
                                Услуги предоставляются по принципу <strong>«как есть» (as is)</strong>. Компания не несет ответственности за любые убытки, 
                                возникшие в результате использования платформы <strong><?= $domainTitle ?></strong>. Мы не гарантируем бесперебойную работу сайта 24/7.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="legal-section" data-gsap="fade-up">
                    ...
                    <p>
                        Мы оставляем за собой право изменять Условия в любое время. Все споры будут решаться путем переговоров. 
                        В случае недостижения согласия, споры рассматриваются в соответствии с законодательством Германии по месту регистрации Оператора.
                    </p>
                </div>
